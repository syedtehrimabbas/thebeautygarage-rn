  ...
  return (<AppContainer
    ...
    children={<View style={[AppStyles.centerItems, { paddingTop: 10 }]}>
      ...
      <View style={{
        ...
        <AppButton label={"Next"} backgroundColor={colors.red} onPress={() => navigation.navigate("ConfirmOrder",{addressInfo:route.params.addressInfo,cashOnDelivery:cashOnDelivery})}
